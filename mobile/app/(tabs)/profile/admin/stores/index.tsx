// mobile/app/(tabs)/profile/admin/stores/index.tsx
...
export default function AdminStoresScreen() {
  ...
  const handleStorePress = (storeId: number) => {
    router.push({
      pathname: '/(tabs)/profile/admin/stores/[id]',
      params: { id: storeId },
    });
  };
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await productService.deleteStore(storeId);
      ...
      <Card style={{ backgroundColor: theme.colors.surface, marginBottom: 12 }}>
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            {item.address && (
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8, gap: 4 }}>
                <Ionicons name="navigate-outline" size={12} color={theme.colors['text-muted']} />
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingVertical: 40 }}>
        ...
        <Text style={{ color: theme.colors['text-secondary'], textAlign: 'center' }}>
          Create or import stores to get started
        </Text>
      </View>
    );
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      ...
      {/* Create Button */}
      <TouchableOpacity
        onPress={() => router.push('/(tabs)/profile/admin/stores/create')}
        style={{
          position: 'absolute',
          bottom: 20,
          right: 20,
